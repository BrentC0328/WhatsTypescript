...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.onsubmit = function (event) { return __awaiter(void 0, void 0, void 0, function () {
        var formData, word, response, data, theDefinition, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    data = _a.sent();
                    theDefinition = data[0].meanings[0].definitions[0].definition;
...
function update(container, word) {
    var listItems = "<li>".concat(word, "</li>");
